...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class JetbrainsLibraryAccessors extends SubDependencyFactory {
        private final JetbrainsComposeLibraryAccessors laccForJetbrainsComposeLibraryAccessors = new JetbrainsComposeLibraryAccessors(owner);

        public JetbrainsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>jetbrains.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public JetbrainsComposeLibraryAccessors getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForJetbrainsComposeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class JetbrainsComposeLibraryAccessors extends SubDependencyFactory {

        public JetbrainsComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>material3</b> with <b>org.jetbrains.compose.material3:material3</b> coordinates and
         * with version reference <b>compose.material3.desktop</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getMaterial3() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("jetbrains.compose.material3");
        }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        private final ComposeMaterial3VersionAccessors vaccForComposeMaterial3VersionAccessors = new ComposeMaterial3VersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.compose.material3</b>
         */
        public ComposeMaterial3VersionAccessors getMaterial3() {
            return vaccForComposeMaterial3VersionAccessors;
        }

    }

    public static class ComposeMaterial3VersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public ComposeMaterial3VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>compose.material3</b> with value <b>1.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("compose.material3"); }

        /**
         * Version alias <b>compose.material3.desktop</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDesktop() { return getVersion("compose.material3.desktop"); }
